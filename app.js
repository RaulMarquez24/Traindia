...
const app = {
  ...
  renderMore() {
    ...
    return `<div class="section">
      ...
      <p class="version-foot">Traindía · v2.6.1 · ${Object.keys(this.usersById).length} perfil(es)<br>© 2026 Raúl Márquez · <a class="foot-link" href="${this.REPO_URL}" target="_blank" rel="noopener">Ver en GitHub ↗</a></p>
    </div>`;
  },
  bindMore(root) {
  ...
  renderSettings() {
    ...
    return `<div class="section">
      ...
      <p class="version-foot">Traindía · v2.6.1</p>
    </div>`;
  },
